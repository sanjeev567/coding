//<---------------pure function and abstract base class------------->
// class in which atleast one pure function have is called abstract base class
#include <iostream>
#include <cstring>
using namespace std;

class google //this class is made for only to inherit thing and create another class
